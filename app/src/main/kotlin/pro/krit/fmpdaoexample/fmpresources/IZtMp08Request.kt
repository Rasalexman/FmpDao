...
interface IZtMp08Request : IRequest.IBaseRequest {//IRestRequest<ZtMp05RequestResultModel, ZtMp05RequestRespondStatus> { //IRestRequest<ZtMp05RequestResultModel, ZtMp05RequestRespondStatus> {
